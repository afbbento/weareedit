                    ...
                    ?>
                            <div class="col-md-3 col-sm-6 <?php echo $text_color; ?>">
                                ...
                                <div class="course-text">
                                    ...
                                    <div class="course-title"><a href="<?php echo $link_relacionado_formacao; ?>"><?php echo $titulo_relacionado_formacao; ?></a></div>
                                </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="related-card">
                                                    <div class="related-card-image-wrap">
                                                        <img class="related-card-img" src="<?php echo $imagem_relacionado_profissao['url'];?>">
                                                    </div>
                                                    <div class="related-card-inner">
                                                        <div class="title"><a href="<?php echo $link_relacionado_profissao; ?>"><?php echo $titulo_relacionado_profissao; ?></a></div>
                                                        <a class="view-more" href="<?php echo $link_relacionado_profissao; ?>">Ver</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <?php
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        ?>
                                            <div class="col-sm-6">
                                                <div class="related-card">
                                                    <div class="related-card-image-wrap">
                                                        <img class="related-card-img" src="<?php echo $imagem_relacionado_entrevista['url'];?>">
                                                    </div>
                                                    <div class="related-card-inner">
                                                        <div class="title"><a href="<?php echo $link_relacionado_entrevista; ?>"><?php echo $titulo_relacionado_entrevista; ?></a></div>
                                                        <a class="view-more" href="<?php echo $link_relacionado_entrevista; ?>">Ver</a>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row reveal-block">
                                    <div class="col-sm-3">
                                        <div class="related-card">
                                            <div class="related-card-image-wrap">
                                                <img class="related-card-img" src="<?php echo get_template_directory_uri(); ?>/img/related@2x.jpg">
                                            </div>
                                            <div class="related-card-inner">
                                                <div class="title"><a href="#">Inspire Others: Product Designer/Manager @ Uniplaces</a></div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="related-card">
                                                    <div class="related-card-image-wrap">
                                                        <img class="related-card-img" src="<?php echo $imagem_relacionado_noticia['url'];?>">
                                                    </div>
                                                    <div class="related-card-inner">
                                                        <div class="title"><a href="<?php echo $link_relacionado_noticia;?>"><?php echo $titulo_relacionado_noticia;?></a></div>
                                                        <a class="view-more" href="<?php echo $link_relacionado_noticia;?>">Ver</a>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="related-card">
                                                    <div class="related-card-image-wrap">
                                                        <img class="related-card-img" src="<?php echo $imagem_relacionado_blog_post['url'];?>">
                                                    </div>
                                                    <div class="related-card-inner">
                                                        <div class="title"><a href="<?php echo $link_relacionado_blog_post;?>"><?php echo $titulo_relacionado_blog_post;?></a></div>
                                                        <a class="view-more" href="<?php echo $link_relacionado_blog_post;?>">Ver</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <?php
