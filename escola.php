            ...
            <div class="row">
                ...
                <div class="col-md-8 col-md-offset-0 col-sm-11 col-sm-offset-1">
                    <div class="row sp-60">
                        ...
                        <div class="col-sm-6">
                            <p class="reveal-blkock">Estes parceiros participam na adequação dos conteúdos programáticos
                                dos cursos da EDIT. às necessidades reais do mercado, sendo esta a melhor forma de
                                conceder aos alunos uma educação moderna e competitiva.</p>
                        </div>
                    </div>
                    <hr class="light-grey">
...
<section class="parceiros bg-black">
    <div class="container">
        ...
        <div class="row grid-sp-40 logos-grid">
            <div class="col-xs-6 col-md-3 col-sm-6 col-md-offset-0 col-sm-offset-1">
                <div class="grid-box">
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-md-offset-0 col-sm-11 col-sm-offset-1">
                <div class="text-block-container">
                    <div class="row sp-60">
                        <div class="col-sm-12">
                            <p>A envolvência direta entre empresas e agências interativas e de marketing digital na
                                estruturação da oferta formativa da EDIT., permite apresentar um leque de programas e
                        ...
                        <div class="col-sm-6">
                            <p>Marcas como a ASUS, Samsung Portugal, Uber, Somersby, TAP Portugal, Farfetch,
                                ...
                                pelas equipas de alunos, ao longo dos diferentes semestres.</p>
                        </div>
                        <div class="col-md-12 col-sm-12">
                            <p>Deste modo, o desenvolvimento de campanhas digitais no projeto final permite aos alunos:
                            </p>
                        </div>
                        <div class="col-md-12 col-sm-12">
                ...
                <div class="text-block-container">
                    <div class="row sp-60">
                        <div class="col-sm-12">
                            <p>Paralelamente à formação na EDIT., os alunos podem usufruir de um conjunto de serviços
